...
public class SegmentationEvaluator extends TransducerEvaluator {
	...
	// "segmentEndTag" should return "true" for the token *after* the end of the
	// segment (i.e. that token
	...
	Object segmentEndTag = new Object() {
		public boolean equals(Object o) {
			return endRegex.matcher(o.toString()).matches();
		}
	};

	public SegmentationEvaluator(InstanceList[] instanceLists,
			String[] descriptions) {
	...
	public SegmentationEvaluator(InstanceList instanceList1,
			String description1, InstanceList instanceList2, String description2) {
		this(new InstanceList[] { instanceList1, instanceList2 }, new String[] {
				description1, description2 });
	}

	public SegmentationEvaluator(InstanceList instanceList1,
			String description1, InstanceList instanceList2,
			String description2, InstanceList instanceList3, String description3) {
		this(
				new InstanceList[] { instanceList1, instanceList2,
						instanceList3 }, new String[] { description1,
